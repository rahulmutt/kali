...
- The memory-safety theorem is still a bounded RC snapshot model, not the full ownership / RC safety proof target from Stage 4.2, even though the current slice now explicitly records the live-to-released transition preservation and the refcount-decrement helper
