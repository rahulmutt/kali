...
- `--lib` is the **base library artifact**, and `--capi` / `--component` are later **public embedding outputs** layered over that same exported-library contract
