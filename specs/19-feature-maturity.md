...
| Registry analysis | none shipped in Phase 1 | under the shared **registry-analysis command split**, no stable public single-package registry-analysis commands ship yet: `kali package-effects` remains the Phase-2 registry-analysis/effect-report command and `kali package-audit` remains **Later compatibility** |
