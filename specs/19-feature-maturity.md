...
| Runtime console routing and assertion semantics | `console.log` / `console.warn` / `console.error` / `console.debug` / `console.info` routing plus `console.assert` false-branch reporting are covered by runtime smoke tests | broader built-in/object-model widening still follows later rows |
