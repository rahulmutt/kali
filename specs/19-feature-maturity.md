...
| Runtime object enumeration semantics | `Object.keys`, `Object.entries`, and `Object.values` preserve overwrite ordering and integer-like key ordering in runtime smoke coverage, including mirrored `.js` fixtures for both cases | broader object-model widening still follows later rows |
