...
- The same current RC inventory also names `KaliCore.Safety.releaseAndCollectKeepsOtherPositiveCountCells`, keeping the surviving non-target positivity slice explicit.
