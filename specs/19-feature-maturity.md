...
| Registry analysis | none shipped in Phase 1 | no stable public single-package registry-analysis commands yet: no stable public `kali package-effects`, and no stable public `kali package-audit` or separate registry-analysis/security-audit workflow yet |
