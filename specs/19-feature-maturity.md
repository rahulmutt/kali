...
| library-oriented build without a statically known export surface | Rejected by default | Fail with `E5006` instead of inventing reflection-based exports for `--lib` / `--capi` / `--component` |
