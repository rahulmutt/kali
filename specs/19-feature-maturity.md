...
| `kali run --api node main.ts` | Phase 3 target | Reject with `E5506` until the documented Node subset lands |
...
| `kali test --api node` | Phase 3 target | Reject with `E5506` until the documented Node subset lands for test runs too |
