...
- the current published boundary also keeps a local refcount-decrement update helper explicit in the RC snapshot slice, including its release-recording, zero-count collection, and live/released-disjointness bookkeeping, while still stopping short of the fuller ownership/freeing story
