...
- `hostDescription: non-empty, non-whitespace string` — short human-readable description of the intended browser host; validators compare the emitted value after trimming surrounding whitespace, but whitespace-only values still fail
