...
- when present, `threadTopology.liveInstances` is emitted in ascending `instanceId` order and stays duplicate-free so the snapshot remains stable across repeated serializations
