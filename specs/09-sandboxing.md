...
- keep the exact browser-targeted `resources.*` accept/reject matrix canonical in [SPEC.md](../SPEC.md) rather than maintaining a second near-duplicate budget table here
