...
- The current RC snapshot helper slice also pins `KaliCore.Safety.releaseAndCollectKeepsOtherPositiveCountCells`, which keeps the surviving non-target positivity story explicit.
