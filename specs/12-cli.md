...
- Keep the exact browser-targeted `resources.*` acceptance/rejection matrix canonical in [SPEC.md](../SPEC.md) rather than maintaining a second near-duplicate summary here.
