...
- that deterministic `binding-package` sidecar manifest treats `moduleName`, `hostContract`, and `runtimeBackend` as non-empty, non-whitespace machine labels so binding workflows do not accept padded provenance strings
