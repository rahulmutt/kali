...
- dynamic-import resolution now accepts static concatenations, const-bound fragments, and rejects unresolved linked targets with the dedicated `E4008` diagnostic ✅
- resolver tests now cover `const`-bound dynamic-import fragments that fold to a known linked target ✅
