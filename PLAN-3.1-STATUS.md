...
- MIR-aware specialization now has shared closure-layout and struct-layout regression tests so identical higher-order call-site layouts reuse one specialized clone, with the struct-layout case exercised across three matching call sites
