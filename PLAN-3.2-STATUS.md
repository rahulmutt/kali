...
- The remaining follow-on work is to broaden the runtime projection coverage to the rest of the documented Node subset that still lacks host-import wiring, especially the remaining utility/assert pieces, buffer/stream expansions, and any later compatibility breadth beyond the child-process projection.
