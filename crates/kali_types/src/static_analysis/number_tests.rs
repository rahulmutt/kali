        ...
        Statement::ExpressionStatement(ExpressionStatement {
            expression: Box::new(Expression::CallExpression(Box::new(CallExpression {
                callee: Expression::MemberExpression(Box::new(MemberExpression {
                    ...
                    property: Some("isFinite".to_string()),
                })),
        ...
        Statement::ExpressionStatement(ExpressionStatement {
            expression: Box::new(Expression::CallExpression(Box::new(CallExpression {
                callee: Expression::MemberExpression(Box::new(MemberExpression {
                    computed_index: None,
                    object: Expression::Identifier("Number".to_string()),
                    property: Some("isInteger".to_string()),
                })),
        ...
        Statement::ExpressionStatement(ExpressionStatement {
            expression: Box::new(Expression::CallExpression(Box::new(CallExpression {
                callee: Expression::MemberExpression(Box::new(MemberExpression {
                    computed_index: None,
                    object: Expression::Identifier("Number".to_string()),
                    property: Some("isSafeInteger".to_string()),
                })),
                args: vec![Expression::Identifier("alias".to_string())],
            }))),
        }),
            ...
            expression: Box::new(Expression::CallExpression(Box::new(CallExpression {
                callee: Expression::MemberExpression(Box::new(MemberExpression {
                    ...
                    object: Expression::MemberExpression(Box::new(MemberExpression {
                        ...
                        property: Some("Number".to_string()),
                    })),
                    property: Some("isNaN".to_string()),
                })),
