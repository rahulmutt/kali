...
fn test_resolution_supports_process_kill_zero_probe_object_freeze_wrappers_on_node_surface() {
    let dir = tempfile::tempdir().unwrap();
    let source_path = dir.path().join("main.ts");
    let source = r#"Object.freeze(process.kill)(0); Object.freeze(globalThis.process.kill)(0); Object.freeze(globalThis[\"process\"][\"kill\"])(0); Object.freeze(globalThis[\"process\"].kill)(0); Object.freeze(process)[\"kill\"](0); Object.freeze(globalThis.process)[\"kill\"](0); Object.freeze(globalThis[\"process\"])[\"kill\"](0);"#;
    fs::write(&source_path, source).unwrap();
