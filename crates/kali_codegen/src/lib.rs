    ...
    fn emit_call(&mut self, function: &mut Function, node: &LirNode) -> EmittedValue {
        ...
        if self.is_process_kill(&callee_node) {
            ...
            let Some(pid_expr) = args.next() else {
                self.diagnostics.push(Diagnostic::error(
                    e5::FEATURE_UNAVAILABLE as u32,
                    "process.kill is unavailable unless it is invoked as process.kill(0) or one of its supported Node zero-probe aliases (process[\"kill\"](0), globalThis.process.kill(0), globalThis.process[\"kill\"](0), globalThis[\"process\"].kill(0), globalThis[\"process\"][\"kill\"](0), Object.freeze(process.kill)(0), Object.freeze(globalThis.process.kill)(0), Object.freeze(globalThis.process[\"kill\"])(0), Object.freeze(globalThis[\"process\"].kill)(0), Object.freeze(process)[\"kill\"](0), Object.freeze(globalThis.process)[\"kill\"](0), Object.freeze(globalThis[\"process\"])[\"kill\"](0), Object.freeze(globalThis[\"process\"][\"kill\"])(0), and transparent wrapper forms) in the current phase; use the zero liveness-probe subset or the later compatibility path".to_string(),
                ));
                function.instruction(&Instruction::I64Const(0));
                return EmittedValue {
                    produced: true,
