...
fn object_is_lowers_for_static_primitive_literals() {
    let program = parse_and_lower_lir(
        "const flag = true; const text = \"hello\"; console.log(Object.is(flag, true)); console.log(Object.is(text, \"hello\")); console.log(Object.is(Infinity, Infinity)); console.log(Object.is(NaN, NaN)); console.log(Object.is(null, null)); console.log(Object.is(1, 0));",
    );
    let mut ctx = CodegenCtx::new(TargetConfig {
        max_specializations: 16,
        compat_eval: false,
...
fn for_of_object_enumeration_lowers_for_static_object_from_entries_operands() {
    let program = parse_and_lower_lir(
        "for (const key of Object.keys(Object.fromEntries([[\"b\", 1], [\"a\", 2]]))) { console.log(key); }",
    );
    let mut ctx = CodegenCtx::new(TargetConfig {
        max_specializations: 16,
        compat_eval: false,
