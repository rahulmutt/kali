...
fn browser_bundle_bracketed_math_sqrt_cbrt_source() -> &'static str {
    r##"// kali-tree-shake: bracketedMathSqrtCbrtZeroIdentities
function bracketedMathSqrtCbrtZeroIdentities() {
  const four = 4;
...
fn browser_harness_bracketed_math_sqrt_cbrt_run_source() -> &'static str {
...
fn browser_harness_bracketed_math_sqrt_cbrt_test_source() -> &'static str {
    r#"Kali.test('bracketed math sqrt/cbrt zero identities', () => {
  const four = 4;
  const minusTwentySeven = -27;
  console.log(globalThis["Math"]["sqrt"](four));
  console.log(globalThis["Math"]["cbrt"](minusTwentySeven));
...
fn assert_browser_bundle_bracketed_math_sqrt_cbrt(filename: &str, json_output: bool) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join(filename);
    fs::write(
        &source_path,
        browser_bundle_bracketed_math_sqrt_cbrt_source(),
    )
    .expect("write source");
...
await mod.bracketedMathSqrtCbrtZeroIdentities();
"#,
    );
...
fn assert_browser_harness_bracketed_math_sqrt_cbrt(
    command: &str,
    filename: &str,
    source: &str,
    json_output: bool,
...
#[test]
fn build_emits_bracketed_math_sqrt_and_cbrt_zero_identities_in_js_input() {
    assert_browser_bundle_bracketed_math_sqrt_cbrt("app.js", false);
}

#[test]
fn build_emits_bracketed_math_sqrt_and_cbrt_zero_identities_in_ts_input() {
    assert_browser_bundle_bracketed_math_sqrt_cbrt("app.ts", false);
}
...
#[test]
fn run_supports_bracketed_math_sqrt_and_cbrt_zero_identities_when_browser_harness_is_configured_in_js_input(
) {
...
#[test]
fn run_supports_bracketed_math_sqrt_and_cbrt_zero_identities_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_bracketed_math_sqrt_cbrt(
        "run",
        "main.ts",
...
#[test]
fn test_supports_bracketed_math_sqrt_and_cbrt_zero_identities_when_browser_harness_is_configured_in_js_input(
) {
    assert_browser_harness_bracketed_math_sqrt_cbrt(
        "test",
        "smoke.test.js",
...
#[test]
fn test_supports_bracketed_math_sqrt_and_cbrt_zero_identities_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_bracketed_math_sqrt_cbrt(
        "test",
        "smoke.test.ts",
...
#[test]
fn json_run_supports_bracketed_math_sqrt_and_cbrt_zero_identities_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_bracketed_math_sqrt_cbrt(
        "run",
        "main.ts",
...
#[test]
fn json_test_supports_bracketed_math_sqrt_and_cbrt_zero_identities_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_bracketed_math_sqrt_cbrt(
        "test",
        "smoke.test.ts",
