...
fn browser_bundle_global_this_math_hypot_frozen_aliases_source() -> &'static str {
    r##"// kali-tree-shake: globalThisMathHypotFrozenAliasSlice
function globalThisMathHypotFrozenAliasSlice() {
  const three = 3;
  const four = 4;
  ...
  const frozenParenthesizedDotRootMathHypot = Object.freeze((globalThis.Math))["hypot"];
  const frozenParenthesizedDotRootMathHypotSingle = Object.freeze((globalThis.Math))['hypot'];
  ...
  console.log(frozenParenthesizedDotRootMathHypot(three, four));
  console.log(frozenParenthesizedDotRootMathHypotSingle(three, four));
  return [
...
fn assert_browser_bundle_global_this_math_hypot_frozen_aliases(filename: &str, json_output: bool) {
    ...
    fs::write(
        &source_path,
        browser_bundle_global_this_math_hypot_frozen_aliases_source(),
    )
    .expect("write source");
...
await mod.globalThisMathHypotFrozenAliasSlice();
"#,
    );
...
fn assert_browser_harness_global_this_math_hypot_frozen_aliases(
    command: &str,
    filename: &str,
    source: &str,
    json_output: bool,
...
#[test]
fn build_emits_global_this_math_hypot_frozen_alias_slice_in_js_input() {
    assert_browser_bundle_global_this_math_hypot_frozen_aliases("app.js", false);
}

#[test]
fn build_emits_global_this_math_hypot_frozen_alias_slice_in_ts_input() {
    assert_browser_bundle_global_this_math_hypot_frozen_aliases("app.ts", false);
}

#[test]
fn json_build_emits_global_this_math_hypot_frozen_alias_slice_in_js_input() {
    assert_browser_bundle_global_this_math_hypot_frozen_aliases("app.js", true);
}

#[test]
fn json_build_emits_global_this_math_hypot_frozen_alias_slice_in_ts_input() {
    assert_browser_bundle_global_this_math_hypot_frozen_aliases("app.ts", true);
}

#[test]
fn build_emits_global_this_math_hypot_frozen_alias_slice_in_jsx_and_tsx_input() {
    for filename in ["app.jsx", "app.tsx"] {
        assert_browser_bundle_global_this_math_hypot_frozen_aliases(filename, false);
        assert_browser_bundle_global_this_math_hypot_frozen_aliases(filename, true);
    }
}

#[test]
fn run_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_js_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "run",
        "main.js",
        browser_harness_global_this_math_hypot_frozen_aliases_run_source(),
        false,
    );
}

#[test]
fn run_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "run",
        "main.ts",
...
#[test]
fn test_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_js_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "test",
        "main.js",
        browser_harness_global_this_math_hypot_frozen_aliases_test_source(),
        false,
    );
}

#[test]
fn test_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "test",
        "main.ts",
...
#[test]
fn run_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_json_js_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "run",
        "main.js",
...
#[test]
fn run_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_json_ts_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "run",
        "main.ts",
...
#[test]
fn test_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_json_js_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "test",
        "main.js",
...
#[test]
fn test_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_json_ts_input(
) {
    assert_browser_harness_global_this_math_hypot_frozen_aliases(
        "test",
        "main.ts",
...
#[test]
fn run_and_test_supports_global_this_math_hypot_frozen_alias_slice_when_browser_harness_is_configured_in_js_ts_jsx_and_tsx_input(
) {
