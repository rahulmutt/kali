...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_is_missing_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("missing-summary.test.tsx");
...
#[test]
fn run_falls_back_to_stdout_when_browser_summary_file_is_missing_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_is_whitespace_only_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("whitespace-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_canonicalizes_whitespace_padded_host_labels_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("padded-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_run_canonicalizes_whitespace_padded_host_labels_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("padded-summary.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_whitespace_only_host_labels_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("whitespace-labels-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_run_falls_back_to_stdout_when_browser_summary_file_has_whitespace_only_host_labels_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("whitespace-labels-summary.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn run_falls_back_to_stdout_when_browser_summary_file_is_whitespace_only_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("whitespace-summary.tsx");
    write_tsx_source(&source_path);
...
fn json_test_falls_back_to_stdout_when_browser_summary_file_is_empty_when_browser_harness_is_configured_in_tsx_input(
    ...
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("empty-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_invalid_tests_failed_type_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn run_falls_back_to_stdout_when_browser_summary_file_has_invalid_tests_failed_type_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-summary.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_null_args_and_tests_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("null-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_unexpected_keys_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("unexpected-keys-summary.test.tsx");
    write_tsx_source(&source_path);
...
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_invalid_numeric_tests_failed_value_when_browser_harness_is_configured_in_tsx_input(
    ...
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-numeric-summary.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn run_falls_back_to_stdout_when_browser_summary_file_has_invalid_numeric_tests_failed_value_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-numeric-summary.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_invalid_args_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-args.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn json_test_falls_back_to_stdout_when_browser_summary_file_has_invalid_tests_array_items_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-tests-array-items.test.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn run_falls_back_to_stdout_when_browser_summary_file_has_invalid_tests_array_items_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("invalid-tests-array-items.tsx");
    write_tsx_source(&source_path);
...
#[test]
fn run_falls_back_to_stdout_when_browser_summary_file_thread_topology_script_url_is_whitespace_padded_when_browser_harness_is_configured_in_tsx_input(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("thread-topology-summary.tsx");
    write_tsx_source(&source_path);
