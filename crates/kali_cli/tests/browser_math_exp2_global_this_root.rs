...
function globalThisMathExp2NonNegativeIntegerLiterals() {
  ...
  return [globalThis.Math.exp2(exponent), globalThis.Math["exp2"](exponent), globalThis["Math"].exp2(exponent), globalThis["Math"]["exp2"](exponent), Object.freeze(globalThis["Math"].exp2)(exponent), Object.freeze((globalThis["Math"].exp2))(exponent), Object.freeze(globalThis.Math.exp2)(exponent), Object.freeze((globalThis.Math.exp2))(exponent), Object.freeze(globalThis.Math["exp2"])(exponent), Object.freeze((globalThis.Math["exp2"]))(exponent), Object.freeze(globalThis["Math"].exp2)(exponent), Object.freeze((globalThis["Math"].exp2))(exponent), Object.freeze((null ?? globalThis.Math.exp2))(exponent), Object.freeze(globalThis["Math"]["exp2"])(exponent), Object.freeze((globalThis["Math"]["exp2"]))(exponent), Object.freeze((false || globalThis["Math"]["exp2"]))(exponent)];
}
"##
}

fn browser_harness_global_this_math_exp2_run_source() -> &'static str {
    "const exponent = 2; console.log(globalThis.Math.exp2(exponent)); console.log(globalThis.Math[\"exp2\"](exponent)); console.log(globalThis[\"Math\"].exp2(exponent)); console.log(globalThis[\"Math\"][\"exp2\"](exponent)); console.log(Object.freeze(globalThis[\"Math\"].exp2)(exponent)); console.log(Object.freeze((globalThis[\"Math\"].exp2))(exponent)); console.log(Object.freeze(globalThis.Math.exp2)(exponent)); console.log(Object.freeze((globalThis.Math.exp2))(exponent)); console.log(Object.freeze(globalThis.Math[\"exp2\"])(exponent)); console.log(Object.freeze((globalThis.Math[\"exp2\"]))(exponent)); console.log(Object.freeze(globalThis[\"Math\"].exp2)(exponent)); console.log(Object.freeze((globalThis[\"Math\"].exp2))(exponent)); console.log(Object.freeze((true && globalThis.Math.exp2))(exponent)); console.log(Object.freeze((globalThis[\"Math\"][\"exp2\"]))(exponent));\n"
}
...
fn assert_browser_bundle_global_this_math_exp2(filename: &str, json_output: bool) {
    ...
    fs::write(&source_path, browser_bundle_global_this_math_exp2_source()).expect("write source");
...
#[test]
fn build_emits_global_this_math_exp2_zero_identity_in_js_input() {
    assert_browser_bundle_global_this_math_exp2("app.js", false);
}

#[test]
fn build_emits_global_this_math_exp2_zero_identity_in_ts_input() {
    assert_browser_bundle_global_this_math_exp2("app.ts", false);
}
...
#[test]
fn json_build_emits_global_this_math_exp2_zero_identity_in_ts_input() {
    assert_browser_bundle_global_this_math_exp2("app.ts", true);
}
...
#[test]
fn run_supports_global_this_math_exp2_zero_identity_when_browser_harness_is_configured_in_ts_input()
{
    assert_browser_harness_global_this_math_exp2(
        "run",
        "main.ts",
...
#[test]
fn test_supports_global_this_math_exp2_zero_identity_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_global_this_math_exp2(
        "test",
        "smoke.test.ts",
