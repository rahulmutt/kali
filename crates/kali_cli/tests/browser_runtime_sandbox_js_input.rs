...
#[test]
fn run_rejects_browser_api_surface_with_malformed_browser_harness_command_in_js_input() {
...
#[test]
fn json_run_rejects_browser_api_surface_with_malformed_browser_harness_command_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "console.log('browser run');").expect("write source");
...
#[test]
fn run_rejects_browser_api_surface_with_sandbox_in_js_input_when_browser_harness_is_configured() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
...
#[test]
fn json_run_rejects_browser_api_surface_with_sandbox_in_js_input_when_browser_harness_is_configured(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    let policy_path = dir.path().join("kali.policy.json");
...
#[test]
fn test_rejects_inherited_browser_api_surface_with_sandbox_in_js_input_when_browser_harness_is_configured(
) {
    let dir = tempdir().expect("tempdir");
...
#[test]
fn json_test_rejects_inherited_browser_api_surface_with_sandbox_in_js_input_when_browser_harness_is_configured(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("smoke.test.js");
    let policy_path = dir.path().join("kali.policy.json");
...
#[test]
fn run_rejects_browser_api_surface_with_sandbox_in_js_input_without_browser_harness() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    let policy_path = dir.path().join("kali.policy.json");
    fs::write(&source_path, "console.log('browser run');").expect("write source");
...
#[test]
fn json_run_rejects_browser_api_surface_with_sandbox_in_js_input_without_browser_harness() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    let policy_path = dir.path().join("kali.policy.json");
    fs::write(&source_path, "console.log('browser run');").expect("write source");
...
#[test]
fn test_rejects_inherited_browser_api_surface_with_sandbox_in_js_input_without_browser_harness() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("smoke.test.js");
    let policy_path = dir.path().join("kali.policy.json");
    fs::write(&source_path, "Kali.test('browser', () => {});").expect("write source");
...
#[test]
fn json_test_rejects_inherited_browser_api_surface_with_sandbox_in_js_input_without_browser_harness(
) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("smoke.test.js");
    let policy_path = dir.path().join("kali.policy.json");
