...
fn browser_bundle_global_this_math_expm1_log1p_source() -> &'static str {
    r##"// kali-tree-shake: globalThisMathExpm1Log1pIdentities
function globalThisMathExpm1Log1pIdentities() {
  const zero = 0;
...
fn browser_harness_global_this_math_expm1_log1p_run_source() -> &'static str {
    "const zero = 0; console.log(globalThis.Math.expm1(zero)); console.log(globalThis.Math.log1p(zero));\n"
}

fn browser_harness_global_this_math_expm1_log1p_test_source() -> &'static str {
    r#"Kali.test('globalThis math expm1/log1p identities', () => {
  const zero = 0;
  console.log(globalThis.Math.expm1(zero));
  console.log(globalThis.Math.log1p(zero));
});
...
fn assert_browser_bundle_global_this_math_expm1_log1p(filename: &str, json_output: bool) {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join(filename);
    fs::write(
        &source_path,
        browser_bundle_global_this_math_expm1_log1p_source(),
    )
    .expect("write source");
...
await mod.globalThisMathExpm1Log1pIdentities();
"#
        ),
    );
...
fn assert_browser_harness_global_this_math_expm1_log1p(
    command: &str,
    filename: &str,
    source: &str,
    json_output: bool,
...
#[test]
fn build_emits_global_this_math_expm1_log1p_identity_literals_in_js_input() {
    assert_browser_bundle_global_this_math_expm1_log1p("app.js", false);
}

#[test]
fn build_emits_global_this_math_expm1_log1p_identity_literals_in_ts_input() {
    assert_browser_bundle_global_this_math_expm1_log1p("app.ts", false);
}
...
#[test]
fn run_supports_global_this_math_expm1_log1p_identity_literals_when_browser_harness_is_configured_in_ts_input(
) {
...
#[test]
fn run_supports_global_this_math_expm1_log1p_identity_literals_when_browser_harness_is_configured_in_js_input(
) {
    assert_browser_harness_global_this_math_expm1_log1p(
        "run",
        "main.js",
...
#[test]
fn test_supports_global_this_math_expm1_log1p_identity_literals_when_browser_harness_is_configured_in_ts_input(
) {
    assert_browser_harness_global_this_math_expm1_log1p(
        "test",
        "smoke.test.ts",
...
#[test]
fn test_supports_global_this_math_expm1_log1p_identity_literals_when_browser_harness_is_configured_in_js_input(
) {
    assert_browser_harness_global_this_math_expm1_log1p(
        "test",
        "smoke.test.js",
