...
fn assert_browser_bundle_template_literal_string_iteration(filename: &str, json_output: bool) {
    ...
    fs::write(
        &source_path,
        browser_bundle_template_literal_string_iteration_source(),
    )
    .expect("write source");
...
await mod.browserTemplateLiteralStringIteration();
"#,
    );
...
#[test]
fn build_emits_browser_template_literal_string_iteration_in_js_input() {
    assert_browser_bundle_template_literal_string_iteration("app.js", false);
}

#[test]
fn build_emits_browser_template_literal_string_iteration_in_ts_input() {
    assert_browser_bundle_template_literal_string_iteration("app.ts", false);
}

#[test]
fn json_build_emits_browser_template_literal_string_iteration_in_js_input() {
    assert_browser_bundle_template_literal_string_iteration("app.js", true);
}
