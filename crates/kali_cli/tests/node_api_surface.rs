...
fn node_api_surface_supports_process_kill_zero_probe_object_freeze_wrappers_in_js_ts_jsx_and_tsx_input_on_check_build_run_and_test_commands(
    ...
    for extension in ["js", "ts", "jsx", "tsx"] {
        for inherited in [false, true] {
            ...
            fs::write(
                &run_file,
                r#"console.log(Object.freeze(process.kill)(0)); console.log(Object.freeze(process.kill)(+0)); console.log(Object.freeze((process.kill))(0)); console.log(Object.freeze((process.kill))(+0)); console.log(Object.freeze(globalThis.process.kill)(0)); console.log(Object.freeze(globalThis.process["kill"])(0)); console.log(process["kill"](+0)); console.log(Object.freeze(globalThis["process"]["kill"])(0)); console.log(Object.freeze(globalThis["process"]["kill"])(+0)); console.log(Object.freeze(globalThis.process["kill"])(0)); console.log(Object.freeze(globalThis.process["kill"])(+0)); console.log(Object.freeze((globalThis.process["kill"]))(0)); console.log(Object.freeze((globalThis.process["kill"]))(+0)); console.log(Object.freeze(globalThis["process"].kill)(0)); console.log(Object.freeze(globalThis["process"].kill)(+0)); console.log(Object.freeze(process)["kill"](0)); console.log(Object.freeze(process)["kill"](+0)); console.log(Object.freeze((process)["kill"])(0)); console.log(Object.freeze((process)["kill"])(+0)); console.log(Object.freeze(globalThis.process)["kill"](0)); console.log(Object.freeze(globalThis.process)["kill"](+0)); console.log(Object.freeze(globalThis["process"])["kill"](0)); console.log(Object.freeze(globalThis["process"])["kill"](+0)); console.log(Object.freeze(globalThis["process"]["kill"])(0)); console.log(Object.freeze(globalThis["process"]["kill"])(+0)); console.log(Object.freeze((globalThis["process"].kill))(0)); console.log(Object.freeze((globalThis["process"].kill))(+0)); console.log(((globalThis["process"]["kill"]))(0)); console.log(((globalThis.process["kill"]))(0)); console.log(((globalThis.process["kill"]))(+0));"#,
            )
            .expect("write run file");
            fs::write(
                &test_file,
                r#"Kali.test('process kill freeze', () => { if (!Object.freeze(process.kill)(0) || !Object.freeze(process.kill)(+0) || !Object.freeze((process.kill))(0) || !Object.freeze((process.kill))(+0) || !Object.freeze(globalThis.process.kill)(0) ||  !Object.freeze(globalThis.process["kill"])(0) || !Object.freeze(globalThis["process"]["kill"])(0) || !Object.freeze(globalThis["process"]["kill"])(+0) || !Object.freeze(globalThis.process["kill"])(0) || !Object.freeze(globalThis.process["kill"])(+0) || !Object.freeze((globalThis.process["kill"]))(0) || !Object.freeze((globalThis.process["kill"]))(+0) || !Object.freeze(globalThis["process"].kill)(0) || !Object.freeze(globalThis["process"].kill)(+0) || !Object.freeze(process)["kill"](0) || !Object.freeze(process)["kill"](+0) || !Object.freeze((process)["kill"])(0) || !Object.freeze((process)["kill"])(+0) || !Object.freeze(globalThis.process)["kill"](0) || !Object.freeze(globalThis.process)["kill"](+0) || !Object.freeze(globalThis["process"])["kill"](0) || !Object.freeze(globalThis["process"])["kill"](+0) || !Object.freeze(globalThis["process"]["kill"])(0) || !Object.freeze(globalThis["process"]["kill"])(+0) || !Object.freeze((globalThis["process"].kill))(0) || !Object.freeze((globalThis["process"].kill))(+0) || !((globalThis["process"]["kill"]))(0) || !((globalThis.process["kill"]))(0) || !((globalThis.process["kill"]))(+0) || !process["kill"](+0)) { throw new Error('expected zero probe'); } });"#,
            )
            .expect("write test file");
