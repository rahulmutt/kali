...
fn assert_browser_harness_for_await_sequence_wrapper(
    command: &str,
    filename: &str,
    json_output: bool,
) {
...
fn run_supports_for_await_array_iteration_with_sequence_wrappers_in_browser_api_surface_with_harness_js_input(
    ...
    assert_browser_harness_for_await_sequence_wrapper("run", "main.js", false);
}

#[test]
fn test_supports_for_await_array_iteration_with_sequence_wrappers_in_browser_api_surface_with_harness_js_input(
) {
    assert_browser_harness_for_await_sequence_wrapper("test", "main.js", false);
}

#[test]
fn json_run_supports_for_await_array_iteration_with_sequence_wrappers_in_browser_api_surface_with_harness_js_input(
) {
    assert_browser_harness_for_await_sequence_wrapper("run", "main.js", true);
}

#[test]
fn json_test_supports_for_await_array_iteration_with_sequence_wrappers_in_browser_api_surface_with_harness_js_input(
) {
    assert_browser_harness_for_await_sequence_wrapper("test", "main.js", true);
}

#[test]
fn supports_for_await_array_iteration_sequence_wrappers_in_browser_api_surface_with_harness_ts_jsx_tsx_input(
) {
    for extension in ["ts", "jsx", "tsx"] {
        ...
        for (command, json_output) in [
            ...
            assert_browser_harness_for_await_sequence_wrapper(command, &filename, json_output);
        }
    }
}
