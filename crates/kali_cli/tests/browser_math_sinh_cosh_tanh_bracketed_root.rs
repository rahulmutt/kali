...
fn browser_bundle_bracketed_global_this_math_sinh_cosh_tanh_source() -> &'static str {
    r##"// kali-tree-shake: bracketedGlobalThisMathSinhCoshTanhZeroIdentities
function bracketedGlobalThisMathSinhCoshTanhZeroIdentities() {
  const zero = 0;
  console.log(globalThis["Math"].sinh(zero));
  console.log(globalThis["Math"].cosh(zero));
  console.log(globalThis["Math"].tanh(zero));
  return [globalThis["Math"].sinh(zero), globalThis["Math"].cosh(zero), globalThis["Math"].tanh(zero)];
}
"##
}

fn assert_browser_bundle_bracketed_global_this_math_sinh_cosh_tanh(
    filename: &str,
    json_output: bool,
) {
    ...
    fs::write(
        &source_path,
        browser_bundle_bracketed_global_this_math_sinh_cosh_tanh_source(),
    )
    .expect("write source");
...
await mod.bracketedGlobalThisMathSinhCoshTanhZeroIdentities();
"#,
    );
...
#[test]
fn build_emits_bracketed_global_this_math_sinh_cosh_tanh_zero_identities_in_js_input() {
    assert_browser_bundle_bracketed_global_this_math_sinh_cosh_tanh("app.js", false);
}

#[test]
fn build_emits_bracketed_global_this_math_sinh_cosh_tanh_zero_identities_in_ts_input() {
    assert_browser_bundle_bracketed_global_this_math_sinh_cosh_tanh("app.ts", false);
}
...
#[test]
fn json_build_emits_bracketed_global_this_math_sinh_cosh_tanh_zero_identities_in_ts_input() {
    assert_browser_bundle_bracketed_global_this_math_sinh_cosh_tanh("app.ts", true);
}
