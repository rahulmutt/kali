...
#[path = "browser_for_await_frozen_set_map_constructor_result/run.rs"]
mod run;

#[path = "browser_for_await_frozen_set_map_constructor_result/build.rs"]
mod build;

#[path = "browser_for_await_frozen_set_map_constructor_result/test.rs"]
mod test;
