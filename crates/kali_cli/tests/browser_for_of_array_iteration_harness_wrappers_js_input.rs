...
fn for_of_as_const_source() -> &'static str {
    r##"// kali-tree-shake: forOfArrayIterationAsConstWrapper
const value = 2;
for (const item of ([1, (value)] as const)) {
  console.log(item);
}
"##
}
...
fn for_of_parenthesized_const_alias_source() -> &'static str {
    r##"// kali-tree-shake: forOfArrayIterationParenthesizedConstAliasWrapper
const value = 2;
...
#[test]
fn run_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_ts_input(
) {
    assert_browser_harness_for_of_wrapper("run", "main.ts", for_of_as_const_source(), false);
}

#[test]
fn test_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_ts_input(
) {
    assert_browser_harness_for_of_wrapper("test", "main.ts", for_of_as_const_source(), false);
}

#[test]
fn json_run_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_ts_input(
) {
    assert_browser_harness_for_of_wrapper("run", "main.ts", for_of_as_const_source(), true);
}

#[test]
fn json_test_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_ts_input(
) {
    assert_browser_harness_for_of_wrapper("test", "main.ts", for_of_as_const_source(), true);
}

#[test]
fn run_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper("run", "main.jsx", for_of_as_const_source(), false);
}

#[test]
fn test_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper("test", "main.jsx", for_of_as_const_source(), false);
}

#[test]
fn json_run_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper("run", "main.jsx", for_of_as_const_source(), true);
}

#[test]
fn json_test_supports_for_of_array_iteration_lowering_with_as_const_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper("test", "main.jsx", for_of_as_const_source(), true);
}
...
#[test]
fn run_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_js_input(
) {
...
#[test]
fn test_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_js_input(
) {
    assert_browser_harness_for_of_wrapper(
        "test",
        "main.js",
...
#[test]
fn json_run_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_js_input(
) {
    assert_browser_harness_for_of_wrapper(
        "run",
        "main.js",
...
#[test]
fn json_test_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_js_input(
) {
    assert_browser_harness_for_of_wrapper(
        "test",
        "main.js",
...
#[test]
fn run_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "run",
        "main.jsx",
...
#[test]
fn test_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "test",
        "main.jsx",
...
#[test]
fn json_run_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "run",
        "main.jsx",
...
#[test]
fn json_test_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_jsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "test",
        "main.jsx",
...
#[test]
fn run_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_tsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "run",
        "main.tsx",
...
#[test]
fn test_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_tsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "test",
        "main.tsx",
...
#[test]
fn json_run_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_tsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "run",
        "main.tsx",
...
#[test]
fn json_test_supports_for_of_array_iteration_lowering_with_parenthesized_const_alias_wrapper_in_browser_api_surface_with_harness_tsx_input(
) {
    assert_browser_harness_for_of_wrapper(
        "test",
        "main.tsx",
