...
"#,
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert_eq!(stdout.trim(), "ok 1", "stdout: {stdout}");
}
...
#[test]
fn check_rejects_generator_function_lowering_in_browser_analysis_context() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn check_rejects_generator_function_lowering_in_browser_analysis_context_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn check_rejects_generator_delegating_yield_lowering_in_browser_analysis_context() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
...
#[test]
fn check_rejects_generator_delegating_yield_lowering_in_browser_analysis_context_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn check_rejects_generator_delegating_yield_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn check_rejects_async_generator_lowering() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "async function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn check_rejects_async_generator_function_expression_lowering() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(
        &source_path,
...
#[test]
fn build_rejects_async_generator_function_expression_lowering() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(
        &source_path,
...
#[test]
fn json_run_rejects_async_generator_function_expression_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(
        &source_path,
...
#[test]
fn json_test_rejects_async_generator_function_expression_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("smoke.test.js");
    fs::write(
        &source_path,
...
#[test]
fn json_build_rejects_generator_function_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn json_build_rejects_generator_delegating_yield_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn json_run_rejects_generator_delegating_yield_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn json_test_rejects_generator_delegating_yield_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("smoke.test.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_generator_function_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_generator_function_lowering_in_browser_bundle() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_generator_function_lowering_in_browser_bundle_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_generator_delegating_yield_lowering_in_browser_bundle() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_generator_delegating_yield_lowering_in_browser_bundle_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn json_build_rejects_generator_delegating_yield_lowering_in_browser_bundle() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_async_generator_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "async function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_generator_delegating_yield_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield* []; }\nmain();").expect("write source");
...
#[test]
fn build_rejects_async_generator_lowering() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "async function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn run_rejects_generator_function_lowering() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
...
#[test]
fn run_rejects_generator_function_lowering_in_js_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.js");
    fs::write(&source_path, "function* main() { yield 1; }\nmain();").expect("write source");
