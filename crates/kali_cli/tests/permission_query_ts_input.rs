...
#[test]
fn check_accepts_supported_permission_query_descriptor_const_bindings_in_ts_input() {
...
#[test]
fn build_accepts_supported_permission_query_descriptor_const_bindings_in_ts_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(
        &source_path,
...
#[test]
fn check_rejects_unsupported_permission_query_descriptor_in_ts_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
...
#[test]
fn check_rejects_unsupported_permission_query_descriptor_in_ts_input_in_json() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, unsupported_permission_query_source()).expect("write source");
...
#[test]
fn build_rejects_unsupported_permission_query_descriptor_in_ts_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, unsupported_permission_query_source()).expect("write source");
...
#[test]
fn build_rejects_unsupported_permission_query_descriptor_in_ts_input_in_json() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.ts");
    fs::write(&source_path, unsupported_permission_query_source()).expect("write source");
