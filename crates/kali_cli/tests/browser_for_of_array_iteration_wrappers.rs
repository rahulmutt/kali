...
function forOfArrayIterationAsConstWrapper() {
  const value = 2;
...
#[test]
fn build_emits_for_of_as_const_wrapper_in_js_input() {
...
#[test]
fn json_build_emits_for_of_as_const_wrapper_in_js_input() {
    assert_browser_bundle_for_of_wrapper(
        "app.js",
        true,
        for_of_as_const_source(),
...
#[test]
fn build_emits_for_of_as_const_wrapper_in_ts_input() {
    assert_browser_bundle_for_of_wrapper(
        "app.ts",
        false,
        for_of_as_const_source(),
...
#[test]
fn json_build_emits_for_of_as_const_wrapper_in_ts_input() {
    assert_browser_bundle_for_of_wrapper(
        "app.ts",
        true,
        for_of_as_const_source(),
