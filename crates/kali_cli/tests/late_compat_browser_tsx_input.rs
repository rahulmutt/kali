...
#[test]
fn check_and_build_reject_generator_and_async_generator_class_expressions_in_browser_api_surface_tsx_input(
) {
...
#[test]
fn check_rejects_frozen_intl_number_format_late_compatibility_member_in_tsx_input() {
    let dir = tempdir().expect("tempdir");
    let source_path = dir.path().join("main.tsx");
    fs::write(
        &source_path,
