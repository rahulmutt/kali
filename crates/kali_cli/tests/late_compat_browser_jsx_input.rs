...
fn late_object_model_source() -> &'static str {
    "Intl; globalThis.Intl; globalThis[\"Intl\"]; globalThis.Intl.NumberFormat; globalThis[\"Intl\"].NumberFormat; globalThis.Intl[\"NumberFormat\"]; globalThis.Intl.PluralRules; globalThis[\"Intl\"][\"PluralRules\"]; globalThis[\"Intl\"].PluralRules; globalThis.Intl[\"PluralRules\"]; Proxy; globalThis.Proxy; globalThis[\"Proxy\"]; new Proxy({}, {}); new globalThis.Proxy({}, {}); new globalThis[\"Proxy\"]({}, {}); Proxy.revocable({}, {}); globalThis.Proxy.revocable({}, {}); globalThis[\"Proxy\"][\"revocable\"]({}, {}); globalThis[\"Proxy\"].revocable({}, {}); globalThis.Proxy[\"revocable\"]({}, {}); new WeakMap(); globalThis.WeakMap; globalThis[\"WeakMap\"]; new WeakSet(); globalThis.WeakSet; globalThis[\"WeakSet\"]; new WeakRef(); globalThis.WeakRef; globalThis[\"WeakRef\"]; new FinalizationRegistry(() => {}); globalThis.FinalizationRegistry; globalThis[\"FinalizationRegistry\"]; globalThis.SharedArrayBuffer; globalThis.Atomics;"
}
