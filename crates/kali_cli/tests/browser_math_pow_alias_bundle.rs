...
use kali_common::math_pow_browser_alias_inventory_invocation_lines;
...
#[test]
fn build_emits_math_pow_alias_chain_in_js_input() {
    assert_browser_bundle_math_pow_alias("app.js", false);
}

#[test]
fn build_emits_math_pow_alias_chain_in_ts_input() {
    assert_browser_bundle_math_pow_alias("app.ts", false);
}
