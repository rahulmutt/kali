...
fn assert_check_source_file_supports_set_constructor_iteration_in_input(
    ...
    fs::write(
        &source_path,
        "for (const value of new Set([1, 2, 1])) { console.log(value); } for (const value of new Set(Object.freeze([1, 2, 1]))) { console.log(value); } for (const value of new globalThis[\"Set\"]([1, 2, 1])) { console.log(value); } for (const value of new globalThis['Set'](Object.freeze([1, 2, 1]))) { console.log(value); }\n",
    )
    .expect("write source");
