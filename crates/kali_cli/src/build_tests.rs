...
fn assert_build_source_file_supports_global_this_math_round_identity_in_input(
    ...
    fs::write(
        &source_path,
        "const value = 1.6; console.log(globalThis.Math.round(value)); console.log(globalThis.Math[\"round\"](value)); console.log(globalThis[\"Math\"].round(value)); console.log(globalThis[\"Math\"][\"round\"](value)); console.log(Object.freeze(globalThis.Math.round)(value)); console.log(Object.freeze(Math.round)(value));\n",
    )
    .expect("write source");
