    ...
    match object.get("diagnosticNotes") {
        Some(Value::Array(items)) => {
            ...
            let expected_diagnostic_notes = [
                ...
                Value::String(
                    "browser runtime summary fallback: stdout wins when the configured browser harness summary file is missing, unparseable, unreadable, or shape-invalid".to_string(),
                ),
                Value::String(
