...
- [ ] Stage 3.2 Node API layer scaffold
  - Added `kali_api_node` helpers for process/path/crypto/events/buffer/util plus unit tests; runtime wiring and `--api node` enablement still pending.
