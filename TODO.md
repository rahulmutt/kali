...
- ✅ Added dual-package and mixed-format corpus coverage so the representative package set now exercises both conditional exports and mixed CJS/ESM entrypoints.
