...
- The late-object-model test matrix now also pins frozen `Proxy.revocable` aliases in the type checker, keeping the rejection path explicit for wrapper-preserving diagnostics.
