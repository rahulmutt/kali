...
- Late object-model gating now also unwraps await-wrapped `Proxy.revocable` aliases before emitting the canonical E5506 rejection, so async wrappers do not bypass the existing late-compatibility boundary.
