...
- Static reference-root resolution now also tolerates optional-chain-wrapped roots and direct same-reference member-root comparisons, keeping `Object.is` same-reference comparisons aligned with the other transparent wrapper slices.
