...
- Static reference-root resolution now also tolerates optional-chain-wrapped roots, keeping `Object.is` alias-chain smoke aligned with the other transparent wrapper slices.
