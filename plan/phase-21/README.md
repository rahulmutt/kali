...
- Progress: the basic unary-prefix operator slice now includes parser/codegen/runtime coverage for an integer-valued unary bitwise-not `~` smoke path alongside the existing `!`, unary `-`, unary `+`, `void`, and local update-expression paths.
