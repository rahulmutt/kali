...
- Extend the supported `Math.exp2` slice with frozen parenthesized `globalThis.Math.exp2` and `globalThis["Math"]["exp2"]` aliases in the browser harness and bundle smoke lanes.
