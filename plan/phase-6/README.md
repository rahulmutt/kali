...
- Current progress: browser bundle runtime smoke now also exercises async/await sequencing in both TS and `.js` inputs, keeping the browser bundle lane aligned with the same await-order regression the standalone runtime smoke already pins.
