...
- Follow-up: array-mutation coverage should keep the `pop`/`unshift` regression pinned alongside the other runtime-smoke array semantics so the supported behavior stays minimized and deterministic.
