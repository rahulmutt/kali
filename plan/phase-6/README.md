...
- Current progress: browser-targeted package-corpus regressions now also cover `.js` entrypoints for browser replacement-map packages, including a scoped package case, so first-class JavaScript compilation stays exercised in the browser analysis/build lane too.
