...
- Current progress: added regression coverage for arithmetic precedence, array literal length handling, function call return semantics, try/catch exception semantics, and `Object.keys()` object-enumeration semantics in `crates/kali_cli/tests/runtime_smoke.rs`.
