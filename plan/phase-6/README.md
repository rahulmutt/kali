...
- Current progress: browser bundle runtime smoke now also exercises `Math.sign()` semantics in both TS and `.js` input, extending the browser bundle evidence beyond the dynamic-import and crypto smoke cases.
