...
- package-audit now also has a repeated-invocation determinism regression under the determinism smoke lane, so the JSON envelope and findings order stay pinned across back-to-back runs instead of only under a single invocation
