...
- Progress note: the browser runtime contract diagnostics now also spell out the summary-file fallback rule, where stdout remains authoritative when the configured browser harness summary file is missing, unparseable, or shape-invalid.
