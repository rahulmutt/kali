...
- The browser-requested runtime summary merge now also has an end-to-end regression for the stdout-threadTopology fallback path when the summary file omits `threadTopology`, keeping the merge helper and the browser harness outcome aligned.
