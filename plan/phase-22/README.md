...
- The shared late-object-model inventory now also carries the parenthesized single-quoted receiver-wrapped `Proxy.revocable` alias family, including the bracket-access form, alongside the other late-object/runtime spellings, keeping the browser and runtime smoke aligned on that wrapper family too.
