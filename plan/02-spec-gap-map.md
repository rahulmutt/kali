...
- Browser bundle runtime smoke now also exercises async/await sequencing in both TS and `.js` input, keeping the browser bundle lane aligned with the same await-order regression the standalone runtime smoke already pins.
