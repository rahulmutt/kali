...
- Expand ECMA-262 conformance for supported syntax and runtime semantics; async/await sequencing now has a dedicated runtime-smoke regression, and array iteration now has a minimized gated `for...of` rejection fixture, but broader generator and CJS/ESM interop coverage still need more minimized fixtures.
