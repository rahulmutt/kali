...
- Continue hardening JSON payload, artifact-manifest, schema-drift, diagnostics, source spans, and CLI-doc contracts while respecting schema extension posture. Suggested-fix text edits now also reject reversed ranges and unexpected keys, keeping the source-edit machine contract aligned with the span ordering rules.
