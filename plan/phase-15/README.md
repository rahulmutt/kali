...
- Current regression coverage also asserts empty `errors` arrays on successful browser/runtime JSON paths for the promise-allSettled and browser for-of smoke slices, keeping the success-envelope shape explicit without narrowing extension posture.
