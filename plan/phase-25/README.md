...
- Current progress: CLI envelope and build-result artifact entries now also reject empty artifact `path` / `kind` labels, and CLI envelope diagnostics now also sort into stable file/line/column/code order before validation.
