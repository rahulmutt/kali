...
- Continue validating JSON payloads, artifact manifests, diagnostics, source spans, and schema-v1 envelopes at emission boundaries; the CLI envelope validator now also has direct rejection coverage for non-string command/stdout/stderr fields.
