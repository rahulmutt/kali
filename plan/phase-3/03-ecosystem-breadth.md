...
- The browser web-baseline interop corpus now also exercises `next` as one more browser
  ...
  support-rung story.
- The browser web-baseline interop corpus now also exercises `@testing-library/react` as one more
  representative scoped testing-library package name, keeping the browser package corpus breadth
