...
- Current progress: padded package identifiers and malformed `jsr:` selectors now fail the command-shape gate before any registry lookup, keeping the single-identifier contract exact.
