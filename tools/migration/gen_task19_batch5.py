...
def header_for(stem, ex, pr, source_map, cases, used, dollar=False) -> list[str]:
    family, filestem = PLACEMENT[stem]
    lines = ["GENERATED by tools/migration/gen_task19_batch5.py -- do not edit this file by hand. Edit the generator and re-run it with --write; its default mode re-renders every file it owns and fails on any byte difference.",
             "",
