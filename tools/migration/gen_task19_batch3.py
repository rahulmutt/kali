...
def head(stem, subject):
    return ["GENERATED by tools/migration/gen_task19_batch3.py -- do not edit this file by hand. Edit the generator and re-run it with --write; its default mode re-renders every file it owns and fails on any byte difference.",
            "",
            f"Migrated from tests/{stem}.rs.",
