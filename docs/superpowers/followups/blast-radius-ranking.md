...
| this document generated at | `c73566936c` | `git rev-parse HEAD`, recorded by the generator |
...
12 of the 30 ranked entries have a second cluster the register names with a concrete destination. Each is moved to it, alone, and both band 1s are recomputed. A clustering that cannot be argued with is not a measurement, so the argument is priced here rather than asserted away.
...
Spec §8.1 removes these 21 entries for **two different reasons**, and collapsing them would misdescribe 2 of them:

- **Not damage** — `FIXED`, `FAIL_CLOSED`, `BOTH_REJECT`. kali either agrees with node or refuses honestly. 19 entries leave this way: R-01, R-02, R-03, R-04, R-05, R-07, R-11, R-12, R-13, R-19, R-20, R-32, R-33, R-49, R-56, R-59, R-63, R-66, R-67.
...
Only 4 of the 21 removed entries have a nonzero reachable count at all: R-07 (78) and R-13 (43) and R-59 (25) and R-67 (7). The largest of them, R-07 at 78, is **the largest reachable count anywhere in `counts.json`** — larger than the largest that survives the filter (R-30 at 57). The ranking's numeric input is much thinner than the raw measurement looks.

And of the 30 entries that do enter, **7 have a reachable count above zero** (R-06 = 1, R-08 = 14, R-10 = 1, R-14 = 7, R-30 = 57, R-31 = 2, R-65 = 5); 20 measure zero and 3 have no count at all. The bands below separate 19 clusters on the evidence of 7 nonzero entries.
